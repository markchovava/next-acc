...
export default function AfricaMap() {
  ...
  return (
    <>
      <section id='africa__map' className='w-[100%] bg-gradient-to-br from-yellow-100 to-yellow-800'>
        <div
          ...
          <div className='lg:w-[40%] w-[100%] p-8 lg:mb-0 mb-[4rem]'>
              ...
              <p className='text-yellow-900 italic'>Click a Country on the map to get more info.</p>
            </div>
