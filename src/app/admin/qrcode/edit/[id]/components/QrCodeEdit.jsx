...
export default function QrCodeEdit({ id }) {
    ...
    async function searchData() {
        ...
        try{
            const result = await axiosClientAPI.get(`user-email-search?search=${search}`, config)
            .then((response) => {
    ...
    async function postData() {
        ...
        try{
            const result = await axiosClientAPI.post(`qrcode-assign-user`, formData, config)
            .then((response) => {
