        ...
        <div className='mx-auto w-[90%] grid lg:grid-cols-2 grid-cols-1 gap-4'>
            ...
            <div className='w-[100%] p-4'>
                ...
                <div className='w-[100%] mb-3'>
                    ...
                    <input type='text' className='w-[100%] rounded-lg py-2 px-3 outline-none border border-slate-200' />
                </div>
                {/*  */}
                <div className='w-[100%] mb-3'>
                    <p className='mb-1'>
                ...
                <div className='w-[100%] mb-3'>
                    ...
                    <textarea type='text' className='w-[100%] h-[8rem] rounded-lg py-2 px-3 outline-none border border-slate-200'></textarea>
                </div>
        ...
        <div className='mx-auto w-[90%] grid lg:grid-cols-3 grid-cols-1 gap-8'>
            ...
            <div className='w-[100%] bg-white drop-shadow-lg p-4'>
                ...
                <ul className='font-light'>
                    <li className='flex items-center justify-start gap-2 mb-2'>
                        <FaPhoneAlt /> <span>+263 782 210021</span>
                    </li>
                    <li className='flex items-center justify-start gap-2 mb-2'>
                        <MdOutlineEmail /> <span>info@acc.com</span>
                    </li>
                </ul>
            </div>
            {/*  */}
